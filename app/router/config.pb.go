...
func (x *StrategyWeightedRoundRobinConfig) GetCosts() []*StrategyWeight {
	if x != nil {
		return x.Costs
	}
	return nil
...
var file_app_router_config_proto_rawDesc = []byte{
	...
	0x65, 0x22, 0x59, 0x0a, 0x20, 0x53, 0x74, 0x72, 0x61, 0x74, 0x65, 0x67, 0x79, 0x57, 0x65, 0x69,
	...
	0x65, 0x69, 0x67, 0x68, 0x74, 0x52, 0x05, 0x63, 0x6f, 0x73, 0x74, 0x73, 0x22, 0x9b, 0x02, 0x0a,
...
var file_app_router_config_proto_depIdxs = []int32{
	...
	10, // 19: xray.app.router.StrategyWeightedRoundRobinConfig.costs:type_name -> xray.app.router.StrategyWeight
